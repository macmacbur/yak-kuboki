...
function traducirInterfaz(lang) {
    const dic = {
        'en': { n: "Your Name:", p: "Type here...", b: "LET'S PLAY!", e: "How old are you?", f: "Choose your flag:", g: "Hello! I'm your friend Yak", m: "CLICK THE MICROPHONE TO TALK TO YAK!", mr: "MICROPHONE READY!", gL: "Are you a Boy or a Girl?", gB: "ðŸ‘¦ Boy", gG: "ðŸ‘§ Girl", pwaBtnMsg: "Download App (Quick Access)", pwaTitle: "Take Kuboki with you!", pwaGotIt: "Got it!" },
        'es': { n: "Tu Nombre:", p: "Escribe aquÃ­...", b: "Â¡A JUGAR!", e: "Â¿CuÃ¡ntos aÃ±os tienes?", f: "Elige tu bandera:", g: "Â¡Hola! Soy tu amigo Yak", m: "Â¡HAZ CLIC EN EL MICRÃ“FONO PARA HABLAR CON YAK!", mr: "Â¡MICRÃ“FONO LISTO!", gL: "Â¿Eres NiÃ±o o NiÃ±a?", gB: "ðŸ‘¦ NiÃ±o", gG: "ðŸ‘§ NiÃ±a", pwaBtnMsg: "Descargar Ãcono (Acceso Directo)", pwaTitle: "Â¡Lleva a Kuboki contigo!", pwaGotIt: "Â¡Entendido!" },
        'pt': { n: "Seu Nome:", p: "Escreva aqui...", b: "VAMOS JOGAR!", e: "Quantos anos vocÃª tem?", f: "Escolha sua bandeira:", g: "OlÃ¡! Sou seu amigo Yak", m: "CLIQUE NO MICROFONE PARA FALAR COM YAK!", mr: "MICROFONE PRONTO!", gL: "VocÃª Ã© Menino ou Menina?", gB: "ðŸ‘¦ Menino", gG: "ðŸ‘§ Menina", pwaBtnMsg: "Baixar Ãcone (Acesso Direto)", pwaTitle: "Leve o Kuboki com vocÃª!", pwaGotIt: "Entendi!" },
        'fr': { n: "Votre Nom:", p: "Ã‰crivez ici...", b: "JOUONS!", e: "Quel Ã¢ge as-tu?", f: "Choisissez votre drapeau:", g: "Bonjour ! Je suis ton ami Yak", m: "CLIQUE SUR LE MICRO POUR PARLER Ã€ YAK!", mr: "MICRO PRÃŠT!", gL: "Es-tu un GarÃ§on ou une Fille ?", gB: "ðŸ‘¦ GarÃ§on", gG: "ðŸ‘§ Fille", pwaBtnMsg: "TÃ©lÃ©charger l'icÃ´ne (AccÃ¨s direct)", pwaTitle: "Emportez Kuboki avec vous !", pwaGotIt: "Compris !" },
        'it': { n: "Il Tuo Nome:", p: "Scrivi qui...", b: "GIOCHIAMO!", e: "Quanti anni hai?", f: "Scegli la tua bandiera:", g: "Ciao! Sono il tuo amico Yak", m: "CLICCA SUL MICROFONO PER PARLARE CON YAK!", mr: "MICROFONO PRONTO!", gL: "Sei un Bambino o una Bambina?", gB: "ðŸ‘¦ Bambino", gG: "ðŸ‘§ Bambina", pwaBtnMsg: "Scarica l'icona (Accesso diretto)", pwaTitle: "Porta Kuboki con te!", pwaGotIt: "Capito!" },
        'de': { n: "Dein Name:", p: "Hier schreiben...", b: "SPIELEN!", e: "Wie alt bist du?", f: "WÃ¤hle deine Flagge:", g: "Hallo! Ich bin dein Freund Yak", m: "KLICKE AUF DAS MIKROFON, UM MIT YAK ZU SPRECHEN!", mr: "MIKROFON BEREIT!", gL: "Bist du ein Junge oder ein MÃ¤dchen?", gB: "ðŸ‘¦ Junge", gG: "ðŸ‘§ MÃ¤dchen", pwaBtnMsg: "Symbol herunterladen (Direktzugriff)", pwaTitle: "Nimm Kuboki mit!", pwaGotIt: "Verstanden!" },
        'hu': { n: "A neved:", p: "Ãrj ide...", b: "JÃTSSZUNK!", e: "HÃ¡ny Ã©ves vagy?", f: "VÃ¡laszd ki a zÃ¡szlÃ³t:", g: "Szia! Ã‰n vagyok a barÃ¡tod, Yak", m: "KATTINTS A MIKROFONRA, HOGY BESZÃ‰LJ YAKKAL!", mr: "MIKROFON KÃ‰SZ!", gL: "FiÃº vagy LÃ¡ny vagy?", gB: "ðŸ‘¦ FiÃº", gG: "ðŸ‘§ LÃ¡ny", pwaBtnMsg: "Ikon letÃ¶ltÃ©se (KÃ¶zvetlen hozzÃ¡fÃ©rÃ©s)", pwaTitle: "Vidd magaddal Kubokit!", pwaGotIt: "Ã‰rtettem!" },
        'pl': { n: "Twoje imiÄ™:", p: "Wpisz tutaj...", b: "ZAGRAJMY!", e: "Ile masz lat?", f: "Wybierz flagÄ™:", g: "CzeÅ›Ä‡! Jestem twoim przyjacielem Yak", m: "KLIKNIJ MIKROFON, ABY POROZMAWIAÄ† Z YAK!", mr: "MIKROFON GOTOWY!", gL: "JesteÅ› ChÅ‚opcem czy DziewczynkÄ…?", gB: "ðŸ‘¦ ChÅ‚opiec", gG: "ðŸ‘§ Dziewczynka", pwaBtnMsg: "Pobierz ikonÄ™ (Szybki dostÄ™p)", pwaTitle: "Zabierz Kuboki ze sobÄ…!", pwaGotIt: "ZrozumiaÅ‚em!" },
        'no': { n: "Ditt navn:", p: "Skriv her...", b: "LA OSS SPILLE!", e: "Hvor gammel er du?", f: "Velg flagg:", g: "Hei! Jeg er din venn Yak", m: "KLIKK PÃ… MIKROFONEN FOR Ã… SNAKKE MED YAK!", mr: "MIKROFON KLAR!", gL: "Er du en Gutt eller en Jente?", gB: "ðŸ‘¦ Gutt", gG: "ðŸ‘§ Jente", pwaBtnMsg: "Last ned ikon (Direkte tilgang)", pwaTitle: "Ta med deg Kuboki!", pwaGotIt: "SkjÃ¸nner!" },
        'sv': { n: "Ditt namn:", p: "Skriv hÃ¤r...", b: "LÃ…T OSS SPELA!", e: "Hur gammal Ã¤r du?", f: "VÃ¤lj flagga:", g: "Hej! Jag Ã¤r din vÃ¤n Yak", m: "KLICKA PÃ… MIKROFONEN FÃ–R ATT PRATA MED YAK!", mr: "MIKROFON KLAR!", gL: "Ã„r du en Pojke eller en Flicka?", gB: "ðŸ‘¦ Pojke", gG: "ðŸ‘§ Flicka", pwaBtnMsg: "Ladda ner ikon (DirektÃ¥tkomst)", pwaTitle: "Ta med dig Kuboki!", pwaGotIt: "FÃ¶rstÃ¥tt!" },
        'ro': { n: "Numele tÄƒu:", p: "Scrie aici...", b: "SÄ‚ NE JUCÄ‚M!", e: "CÃ¢È›i ani ai?", f: "Alege steagul:", g: "Salut! Sunt prietenul tÄƒu Yak", m: "FÄ‚ CLIC PE MICROFON PENTRU A VORBI CU YAK!", mr: "MICROFON PREGÄ‚TIT!", gL: "EÈ™ti BÄƒiat sau FatÄƒ?", gB: "ðŸ‘¦ BÄƒiat", gG: "ðŸ‘§ FatÄƒ", pwaBtnMsg: "DescarcÄƒ pictograma (Acces direct)", pwaTitle: "Ia Kuboki cu tine!", pwaGotIt: "Am Ã®nÈ›eles!" },
        'nl': { n: "Je naam:", p: "Schrijf hier...", b: "LATEN WE SPELEN!", e: "Hoe oud ben je?", f: "Kies je vlag:", g: "Hallo! Ik ben je vriend Yak", m: "KLIK OP DE MICROFOON OM MET YAK TE PRATEN!", mr: "MICROFOON KLAAR!", gL: "Ben je een Jongen of een Meisje?", gB: "ðŸ‘¦ Jongen", gG: "ðŸ‘§ Meisje", pwaBtnMsg: "Download icoon (Directe toegang)", pwaTitle: "Neem Kuboki met je mee!", pwaGotIt: "Begrepen!" },
        'da': { n: "Dit navn:", p: "Skriv her...", b: "LAD OS SPILLE!", e: "Hvor gammel er du?", f: "VÃ¦lg dit flag:", g: "Hej! Jeg er din ven Yak", m: "KLIK PÃ… MIKROFONEN FOR AT TALE MED YAK!", mr: "MIKROFON KLAR!", gL: "Er du en Dreng eller en Pige?", gB: "ðŸ‘¦ Dreng", gG: "ðŸ‘§ Pige", pwaBtnMsg: "Download ikon (Direkte adgang)", pwaTitle: "Tag Kuboki med dig!", pwaGotIt: "ForstÃ¥et!" },
        'tr': { n: "AdÄ±nÄ±z:", p: "Buraya yazÄ±n...", b: "OYNAYALIM!", e: "KaÃ§ yaÅŸÄ±ndasÄ±n?", f: "BayraÄŸÄ±nÄ± seÃ§:", g: "Merhaba! Ben arkadaÅŸÄ±n Yak'Ä±m", m: "YAK Ä°LE KONUÅžMAK Ä°Ã‡Ä°N MÄ°KROFONA TIKLAYIN!", mr: "MÄ°KROFON HAZIR!", gL: "KÄ±z mÄ±sÄ±n Erkek misin?", gB: "ðŸ‘¦ Erkek", gG: "ðŸ‘§ KÄ±z", pwaBtnMsg: "Simgeyi Ä°ndir (DoÄŸrudan EriÅŸim)", pwaTitle: "Kuboki'yi yanÄ±na al!", pwaGotIt: "AnladÄ±m!" },
        ...
        'vi': { n: "TÃªn cá»§a báº¡n:", p: "Viáº¿t vÃ o Ä‘Ã¢y...", b: "CHÆ I THÃ”I!", e: "Báº¡n bao nhiÃªu tuá»•i?", f: "Chá»n lÃ¡ cá» de báº¡n:", g: "Xin chÃ o! MÃ¬nh lÃ  báº¡n cá»§a báº¡n, Yak", m: "Báº¤M VÃ€O MICRO Äá»‚ NÃ“I CHUYá»†N Vá»šI YAK!", mr: "MICRO ÄÃƒ Sáº´N SÃ€NG!", gL: "Báº¡n lÃ  BÃ© Trai hay BÃ© GÃ¡i?", gB: "ðŸ‘¦ BÃ© Trai", gG: "ðŸ‘§ BÃ© GÃ¡i", pwaBtnMsg: "Táº£i biá»ƒu tÆ°á»£ng (Truy cáº­p trá»±c tiáº¿p)", pwaTitle: "Mang Kuboki theo báº¡n!", pwaGotIt: "ÄÃ£ hiá»ƒu!" },
        'zh': { n: "ä½ çš„åå­—:", p: "åœ¨è¿™é‡Œå†™...", b: "è®©æˆ‘ä»¬çŽ©å§ï¼", e: "ä½ å‡ å²äº†ï¼Ÿ", f: "é€‰æ‹©ä½ çš„å›½æ——:", g: "ä½ å¥½ï¼æˆ‘æ˜¯ä½ çš„æœ‹å‹ç‰¦ç‰›Yak", m: "ç‚¹å‡»éº¦å…‹é£Žä¸Žç‰¦ç‰›Yakäº¤è°ˆï¼", mr: "éº¦å…‹é£Žå·²å‡†å¤‡å¥½ï¼", gL: "ä½ æ˜¯ç”·å­©è¿˜æ˜¯å¥³å­©ï¼Ÿ", gB: "ðŸ‘¦ ç”·å­©", gG: "ðŸ‘§ å¥³å­©", pwaBtnMsg: "ä¸‹è½½å›¾æ ‡ (ç›´æŽ¥è®¿é—®)", pwaTitle: "å¸¦ä¸Šé…·æ³¢åŸºï¼", pwaGotIt: "æ˜Žç™½äº†ï¼" },
        'th': { n: "à¸Šà¸·à¹ˆà¸­à¸‚à¸­à¸‡à¸„à¸¸à¸“:", p: "à¹€à¸‚à¸µà¸¢à¸™à¸—à¸µà¹ˆà¸™à¸µà¹ˆ...", b: "à¸¡à¸²à¹€à¸¥à¹ˆà¸™à¸à¸±à¸™à¹€à¸–à¸­à¸°!", e: "à¸„à¸¸à¸“à¸­à¸²à¸¢à¸¸à¹€à¸—à¹ˆà¸²à¹„à¸£?", f: "à¹€à¸¥à¸·à¸­à¸à¸˜à¸‡à¸‚à¸­à¸‡à¸„à¸¸à¸“:", g: "à¸ªà¸§à¸±à¸ªà¸”à¸µ! à¸‰à¸±à¸™à¸„à¸·à¸­à¹€à¸žà¸·à¹ˆà¸­à¸™à¸‚à¸­à¸‡à¸„à¸¸à¸“ Yak", m: "à¸„à¸¥à¸´à¸à¸—à¸µà¹ˆà¹„à¸¡à¹‚à¸„à¸£à¹‚à¸Ÿà¸™à¹€à¸žà¸·à¹ˆà¸­à¸žà¸¹à¸”à¸„à¸¸à¸¢à¸à¸±à¸š Yak!", mr: "à¹„à¸¡à¹‚à¸„à¸£à¹‚à¸Ÿà¸™à¸žà¸£à¹‰à¸­à¸¡à¹à¸¥à¹‰à¸§!", gL: "à¸„à¸¸à¸“à¹€à¸›à¹‡à¸™à¹€à¸”à¹‡à¸à¸œà¸¹à¹‰à¸Šà¸²à¸¢à¸«à¸£à¸·à¸­à¹€à¸”à¹‡à¸à¸œà¸¹à¹‰à¸«à¸à¸´à¸‡?", gB: "ðŸ‘¦ à¸œà¸¹à¹‰à¸Šà¸²à¸¢", gG: "ðŸ‘§ à¸œà¸¹à¹‰à¸«à¸à¸´à¸‡", pwaBtnMsg: "à¸”à¸²à¸§à¸™à¹Œà¹‚à¸«à¸¥à¸”à¹„à¸­à¸„à¸­à¸™ (à¹€à¸‚à¹‰à¸²à¸–à¸¶à¸‡à¹‚à¸”à¸¢à¸•à¸£à¸‡)", pwaTitle: "à¸žà¸² Kuboki à¹„à¸›à¸”à¹‰à¸§à¸¢!", pwaGotIt: "à¹€à¸‚à¹‰à¸²à¹ƒà¸ˆà¹à¸¥à¹‰à¸§!" },
        'tl': { n: "Pangalan mo:", p: "Isulat dito...", b: "LARO TAYO!", e: "Ilang taon ka na?", f: "Piliin ang bandera:", g: "Kamusta! Ako ang kaibigan mong Yak", m: "I-CLICK ANG MIKROPONO PARA MAKAUSAP SI YAK!", mr: "HANDA NA ANG MIKROPONO!", gL: "Lalaki ka ba o Babae?", gB: "ðŸ‘¦ Lalaki", gG: "ðŸ‘§ Babae", pwaBtnMsg: "I-download ang Icon (Direktang Pag-access)", pwaTitle: "Dalhin si Kuboki!", pwaGotIt: "Nakuha ko!" }
    };
...
Al utilizar este sistema, usted acepta que Kuboki actÃºa como un entorno seguro y controlado, dedicado exclusivamente al entretenimiento y la educaciÃ³n infantil en un marco de respeto total a la legislaciÃ³n internacional de privacidad.\`;
    ...
    document.getElementById('btn-register').onclick = async () => {
        ...
        // TransiciÃ³n Yak
            ...
            const transitionScreen = document.getElementById('yak-transition-screen');
            if (transitionScreen) {
                transitionScreen.classList.add('active');
                document.getElementById('yak-transition-text').innerText = wText.welcome;
